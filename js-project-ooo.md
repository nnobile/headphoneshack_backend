 ...
 **USER STORY: A user should be able to read and create headphones on category**
...
- [X] 7. Create a new branch for building out models `git co -b <branch-name>` . This way you can always go back to the fresh API.
...
- [X] 8. Build your models `rails g model Category name`
    - Migrations
    - Model classes
    - Associations
